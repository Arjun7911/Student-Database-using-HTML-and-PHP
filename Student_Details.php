    ...
    <style>
     .bdy{
      ...
      .form {
        ...
        margin: 0 auto;
       width: 70%;
       box-shadow: 10px 10px 25px rgba(113, 35, 35, 0.393);
      ...
      fieldset{
        ...
        background-image:linear-gradient(white,rgba(250, 229, 255, 0.626));  
      }
      fieldset:hover{
        border-radius: 5px;
        font-size: 16px;
        background-image:linear-gradient(#FEEAFA,#dde5b6d0);
      ...
      ?> 
            <tr>
              <th><b>Student's Name: </b></th>
               <td>
                 ...
                 border-bottom: 2px solid black;" name="Name">
            ...
            <tr>
               ...
               <td>
                ...
                margin: 2px 0;
                box-sizing :border-box; border-radius: 4px ;border: none;
                border-bottom: 2px solid black;"name="Roll_no"/>
                <br /> 
              </td>
                ...
                <br />
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="Branch" style=" 
                      ...
                      margin: 2px 0;
                      box-sizing :border-box; border-radius: 4px ;border: none;
                      border-bottom: 2px solid black;"; placeholder="Enter your Branch">
